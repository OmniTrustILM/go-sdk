...
// Sentinel errors for the Compliance Provider v1 surface. v1-spec error
// codes are SDK-internal and surface only in logs.
//
// Wrap with shared.Error.WithCause / WithProperty to attach context:
//
//	return compliance.ErrGroupNotFound.WithCause(err).WithProperty("uuid", id)
var (
