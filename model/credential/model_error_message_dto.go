...
func NewErrorMessageDto(message string) *ErrorMessageDto {
...
func (o *ErrorMessageDto) GetMessage() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *ErrorMessageDto) GetMessageOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ErrorMessageDto) SetMessage(v string) {
	o.Message = v
}
