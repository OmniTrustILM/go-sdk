...
Requires **Go 1.26.5+** — build with **1.26.6+**, since earlier 1.26 patches ship standard-library vulnerabilities that `govulncheck` reports for anything built with them. The `toolchain` directive in `go.mod` selects 1.26.6.
