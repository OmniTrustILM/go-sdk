...
`authority-v3`, `compliance-v1`/`v2`, `credential-v1`, `cryptography-v1`, `disco-v1`, `entity-v1`, `notification-v1`, `secret-v1`, `multi-v1`. They double as the SDK's integration-test suite (see `connector/examples/internal/itest`).
